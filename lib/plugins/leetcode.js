...
plugin.getSubmission = function(submission, cb) {
  ...
  request(opts, function(e, resp, body) {
    log.debug('leetcode.getSubmission body: ', body);
    e = plugin.checkError(e, resp, 200);
    if (e) return cb(e);
    ...
    if ('runtime_distribution_formatted' in bodyJson) {
      submission.distributionChart =
        JSON.parse(bodyJson.runtime_distribution_formatted);
    }
